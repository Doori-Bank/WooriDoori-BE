        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/api/chat/**").hasAuthority("USER") // LLM 채팅 API는 인증
                                                                                                      // 필요
                                                ...
                                                .requestMatchers("/member/**").hasAuthority("USER") // 나머지 회원 경로는 USER
                                                                                                    // 권한 필요
                                                .requestMatchers("/admin/**").hasAuthority("ADMIN") // 관리자 경로는 ADMIN 권한
                                                                                                    // 필요
